...
import type { ScannedFile, Finding } from '../../core/types';

interface ComplexityResult {
  file: string;
  lines: number;
  longFunctions: { name: string; line: number; length: number }[];
...
function analyzeFileComplexity(file: ScannedFile): ComplexityResult {
...
export function analyzeComplexity(files: ScannedFile[]): Finding[] {
